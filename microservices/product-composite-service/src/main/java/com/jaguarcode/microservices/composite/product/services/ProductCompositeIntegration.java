...
import com.jaguarcode.api.event.Event;
...
import com.jaguarcode.util.http.HttpErrorInfo;
...
import static com.jaguarcode.api.event.Event.Type.CREATE;
import static com.jaguarcode.api.event.Event.Type.DELETE;
...
public class ProductCompositeIntegration implements ProductService, RecommendationService, ReviewService {
    ...
    public Flux<Review> getReviews(int productId) {
        ...
        // Return an empty result if something goes wrong to make it possible for the composite service to return partial responses
        return webClient.get().uri(url).retrieve().bodyToFlux(Review.class).log()
                .onErrorResume(error -> empty());
    }
